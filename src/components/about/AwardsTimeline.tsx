  ...
  return (
    <section className="bg-cream/50 px-6 py-16 sm:py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative mt-10 flex flex-col gap-8 sm:mt-16 sm:gap-12">
          ...
          {awards.map((award, i) => (
            <FadeIn key={award.id} delay={i * 0.1}>
              <div
                className={`relative flex flex-col gap-1.5 pl-8 sm:w-1/2 sm:gap-2 sm:pl-0 ${
                  i % 2 === 0
              ...
              >
                <span
                  className={`absolute left-0 top-1 h-3.5 w-3.5 rounded-full border-2 border-gold bg-ivory ${
                ...
                <h3 className="font-display text-lg text-charcoal sm:text-xl">{award.title}</h3>
